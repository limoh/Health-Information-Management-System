    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Community Health Workers Information</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>{{ $worker->email }}</td>
                    <td>
                        <a href="javascript:void(0)" class="btn btn-primary edit btn-sm" data-id="{{ $worker->id }}"> <i class="bi bi-pencil-square"></i> </a>
                        <a href="javascript:void(0)" class="btn btn-primary delete btn-sm" data-id="{{ $worker->id }}"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
                 @endforeach
                </tbody>
...
<script type="text/javascript">
 $(document).ready(function($){
    ...
    $('#addNewBook').click(function () {
       ...
       $('#ajaxBookModel').html("Add Community Health Worker Information");
    ...
    $('body').on('click', '.edit', function () {
        ...
        $.ajax({
            ...
            success: function(res){
              $('#ajaxBookModel').html("Edit Community Health Worker Information");
              $('#ajax-book-model').modal('show');
              $('#id').val(res.id);
              $('#name').val(res.name);
              $('#email').val(res.email);
